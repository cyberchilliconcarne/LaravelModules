...
class AssetController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('asset::frontend.assets.index', compact('assets'));
    }
    ...
    public function create()
    {
        ...
        return view('asset::frontend.assets.create', compact('categories', 'statuses', 'locations', 'assigned_tos'));
    }
    ...
    public function edit(Asset $asset)
    {
        ...
        return view('asset::frontend.assets.edit', compact('categories', 'statuses', 'locations', 'assigned_tos', 'asset'));
    }
    ...
    public function show(Asset $asset)
    {
        ...
        return view('asset::frontend.assets.show', compact('asset'));
    }
