...
class AssetLocationController extends Controller
{
    public function index()
    {
        ...
        return view('asset::admin.assetLocations.index', compact('assetLocations'));
    }
    ...
    public function create()
    {
        ...
        return view('asset::admin.assetLocations.create');
    }
    ...
    public function edit(AssetLocation $assetLocation)
    {
        ...
        return view('asset::admin.assetLocations.edit', compact('assetLocation'));
    }
    ...
    public function show(AssetLocation $assetLocation)
    {
        ...
        return view('asset::admin.assetLocations.show', compact('assetLocation'));
    }
