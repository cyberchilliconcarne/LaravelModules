...
class AssetCategoryController extends Controller
{
    public function index()
    {
        ...
        return view('asset::admin.assetCategories.index', compact('assetCategories'));
    }
    ...
    public function create()
    {
        ...
        return view('asset::admin.assetCategories.create');
    }
    ...
    public function edit(AssetCategory $assetCategory)
    {
        ...
        return view('asset::admin.assetCategories.edit', compact('assetCategory'));
    }
    ...
    public function show(AssetCategory $assetCategory)
    {
        ...
        return view('asset::admin.assetCategories.show', compact('assetCategory'));
    }
