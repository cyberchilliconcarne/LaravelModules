...
class AssetStatusController extends Controller
{
    public function index()
    {
        ...
        return view('asset::admin.assetStatuses.index', compact('assetStatuses'));
    }
    ...
    public function create()
    {
        ...
        return view('asset::admin.assetStatuses.create');
    }
    ...
    public function edit(AssetStatus $assetStatus)
    {
        ...
        return view('asset::admin.assetStatuses.edit', compact('assetStatus'));
    }
    ...
    public function show(AssetStatus $assetStatus)
    {
        ...
        return view('asset::admin.assetStatuses.show', compact('assetStatus'));
    }
